...
{
    public function attributes()    //添加属性
    {
    ...
    public function rules()
    {
        return [
            ...
            [['content', 'email', 'url', 'user.username', 'post.title'], 'safe'],   //添加到数据规则中
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->join('INNER JOIN', 'post', 'comment.post_id = post.id');        //查询构建器
        ...
        // $dataProvider->sort->attributes['post.title']=[ //排序
